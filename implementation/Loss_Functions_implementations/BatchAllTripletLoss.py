...
class Eval(evaluation.SentenceEvaluator):
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        if self.epoch<11 and self.epoch%2==0:
            ...
            plt.savefig(f'plots/{data}_BatchAllTripletLoss_train' + str(self.epoch) + '.png')
...
plt.tight_layout()
plt.savefig("plots/"+data+"_"+model_name+"_BatchAllTripletLoss.png", format='png', bbox_inches='tight', dpi=300)
